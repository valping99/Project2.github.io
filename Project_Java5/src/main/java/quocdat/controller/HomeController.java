...
public class HomeController {
	...
	public String home(ModelMap model, HttpServletRequest request) {
		...
		String hql = "SELECT hieuboy.employee.id, hieuboy.employee.nameEmployee, "
				...
				+ "SUM(hieuboy.price) AS Tongket,hieuboy.employee.photo "
				+ "FROM Record hieuboy GROUP BY hieuboy.employee.id, hieuboy.employee.nameEmployee,hieuboy.employee.photo "
