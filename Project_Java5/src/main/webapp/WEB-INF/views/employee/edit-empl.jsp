						...
						<div class="content">
							<form:form action="admin/employee/edit-empl/${employee.id}.htm"
								...
								<div class="row">
									...
									<div class="col-ms-12">
										<div class="form-group">
											<label for="exampleInputEmail1">Thư Điện Tử: (<span style="color: red;">*</span>)<form:errors
									...
									<div class="col-md-12">
										<div class="form-group">
											<label>Địa Chỉ: (<span style="color: red;">*</span>)<form:errors path="address"
													class="error" /></label>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label>Số Điện Thoại: (<span style="color: red;">*</span>)<form:errors path="numberPhone"
													class="error" /></label>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label>Ngày Sinh: (<span style="color: red;">*</span>)<form:errors path="birthday"
													class="error" /></label>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label>Hình Ảnh: (<span style="color: red;">*</span>)<form:errors path="photo"
													class="error" /></label>
